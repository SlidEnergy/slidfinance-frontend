...
export class BanksService {
    ...
    public _delete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/api/v1/Banks/${encodeURIComponent(String(id))}`,
            {
    ...
    public getList(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Bank>>(`${this.configuration.basePath}/api/v1/Banks`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
